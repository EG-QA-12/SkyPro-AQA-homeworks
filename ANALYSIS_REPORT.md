> **Внимание:** Этот отчёт отражает состояние и рекомендации на июль 2025 года. Для актуальной архитектуры и структуры используйте [ARCHITECTURE.md](./ARCHITECTURE.md) и [README.md](./README.md).
