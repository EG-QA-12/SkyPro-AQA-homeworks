...
### AuthManager
Центральный менеджер авторизации, координирующий процесс входа и управления сессиями.

### AuthUtils
Вспомогательные функции для работы с авторизацией, включая валидацию и обработку ошибок.

### CookieProvider
Провайдер для работы с cookie-файлами авторизации.
