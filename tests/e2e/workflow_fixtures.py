...
Примечание: ``pytest.skip`` внутри фикстуры пропускает **все** тесты, которые
...
class _WorkflowContext:
    ...
    # Тип `object` означает, что мы можем хранить любое значение без уточнения конкретного типа.
