...
(Сообщество, Задать вопрос, Все вопросы)
"""
...
class TestMainPageCommunity:
    ...
    @allure.description("Проверка что раздел сообщества доступен для неавторизованного пользователя")
    def test_community_accessibility(self):
        """
        Тест проверяет доступность раздела сообщества для неавторизованного пользователя
        """
