...
class TestMainPageReference:
    ...
    @allure.title("Проверка функциональности ставки рефинансирования")
    @allure.description("Проверка что страница ставки рефинансирования работает корректно")
    def test_refinancing_rate_functionality(self):
        """
        Тест проверяет функциональность ставки рефинансирования
        """
        with allure.step("Проверяем доступность ставки рефинансирования"):
            try:
                # Кликаем на "Ставка рефинансирования"
                ...
                # Проверяем наличие характерных элементов
                current_url = self.page.url
                has_correct_url = "43009" in current_url

                allure.attach(
                    f"URL ставки рефинансирования корректен: {has_correct_url}",
                    name="URL проверка")

                if has_correct_url:
                    # Проверяем наличие контента
                    try:
                        # Ищем признаки страницы ставки рефинансирования
                        has_content = (
                            self.page.locator("h1, h2").count() > 0 or
                            self.page.locator(".content, .rate, .refinancing").count() > 0
                        )

                        allure.attach(
                            f"Контент ставки рефинансирования загружен: {has_content}",
                            name="Контент ставки")
                    except Exception as e:
                        allure.attach(
                            f"Ошибка при проверке контента: {e}",
                ...
                allure.attach(
                    f"Ошибка при проверке ставки рефинансирования: {e}",
                    name="Ошибка ставки")

    @allure.title("Проверка функциональности базовой величины")
    @allure.description("Проверка что страница базовой величины работает корректно")
    def test_base_value_functionality(self):
        """
        Тест проверяет функциональность базовой величины
        """
        with allure.step("Проверяем доступность базовой величины"):
            try:
                # Кликаем на "Базовая величина"
                ...
                # Проверяем наличие характерных элементов
                current_url = self.page.url
                has_correct_url = "60204" in current_url

                allure.attach(
                    f"URL базовой величины корректен: {has_correct_url}",
                    name="URL проверка")

                if has_correct_url:
                    # Проверяем наличие контента
                    try:
                        # Ищем признаки страницы базовой величины
                        has_content = (
                            self.page.locator("h1, h2").count() > 0 or
                            self.page.locator(".content, .base, .value").count() > 0
                        )

                        allure.attach(
                            f"Контент базовой величины загружен: {has_content}",
                            name="Контент величины")
                    except Exception as e:
                        allure.attach(
                            f"Ошибка при проверке контента: {e}",
                            name="Ошибка контента")
                ...
                allure.attach(
                    f"Ошибка при проверке базовой величины: {e}",
                    name="Ошибка величины")

    @allure.title("Проверка функциональности средней з/п за январь")
    @allure.description("Проверка что страница средней зарплаты работает корректно")
    def test_average_salary_january_functionality(self):
        """
        Тест проверяет функциональность средней зарплаты за январь
        """
        with allure.step("Проверяем доступность средней з/п за январь"):
            try:
                # Кликаем на "Средняя з/п за январь"
                ...
                # Проверяем наличие характерных элементов
                current_url = self.page.url
                has_correct_url = "490447" in current_url

                allure.attach(
                    f"URL средней з/п корректен: {has_correct_url}",
                    name="URL проверка")

                if has_correct_url:
                    # Проверяем наличие контента
                    try:
                        # Ищем признаки страницы средней зарплаты
                        has_content = (
                            self.page.locator("h1, h2").count() > 0 or
                            self.page.locator(".content, .salary, .average").count() > 0
                        )

                        allure.attach(
                            f"Контент средней з/п загружен: {has_content}",
                            name="Контент зарплаты")
                    except Exception as e:
                        allure.attach(
                            f"Ошибка при проверке контента: {e}",
                            name="Ошибка контента")
                ...
                allure.attach(
                    f"Ошибка при проверке средней з/п: {e}",
                    name="Ошибка зарплаты")

    @allure.title("Проверка функциональности пособий на детей")
    @allure.description("Проверка что страница пособий на детей работает корректно")
    def test_child_allowances_functionality(self):
        """
        Тест проверяет функциональность пособий на детей
        """
        with allure.step("Проверяем доступность пособий на детей"):
            try:
                # Кликаем на "Пособия на детей"
                ...
                # Проверяем наличие характерных элементов
                current_url = self.page.url
                has_correct_url = "694891" in current_url

                allure.attach(
                    f"URL пособий на детей корректен: {has_correct_url}",
                    name="URL проверка")

                if has_correct_url:
                    # Проверяем наличие контента
                    try:
                        # Ищем признаки страницы пособий
                        has_content = (
                            self.page.locator("h1, h2").count() > 0 or
                            self.page.locator(".content, .allowances, .children").count() > 0
                        )

                        allure.attach(
                            f"Контент пособий на детей загружен: {has_content}",
                            name="Контент пособий")
                    except Exception as e:
                        allure.attach(
                            f"Ошибка при проверке контента: {e}",
                            name="Ошибка контента")
                ...
                allure.attach(
                    f"Ошибка при проверке пособий на детей: {e}",
                    name="Ошибка пособий")

    @allure.title("Проверка функциональности базовой арендной величины")
    @allure.description("Проверка что страница базовой арендной величины работает корректно")
    def test_base_rental_value_functionality(self):
        """
        Тест проверяет функциональность базовой арендной величины
        """
        with allure.step("Проверяем доступность базовой арендной величины"):
            try:
                # Кликаем на "Базовая арендная величина"
                ...
                # Проверяем наличие характерных элементов
                current_url = self.page.url
                has_correct_url = "235259" in current_url

                allure.attach(
                    f"URL базовой арендной величины корректен: {has_correct_url}",
                    name="URL проверка")

                if has_correct_url:
                    # Проверяем наличие контента
                    try:
                        # Ищем признаки страницы арендной величины
                        has_content = (
                            self.page.locator("h1, h2").count() > 0 or
                            self.page.locator(".content, .rental, .base").count() > 0
                        )

                        allure.attach(
                            f"Контент базовой арендной величины загружен: {has_content}",
                            name="Контент аренды")
                    except Exception as e:
                        allure.attach(
                            f"Ошибка при проверке контента: {e}",
                ...
                allure.attach(
                    f"Ошибка при проверке базовой арендной величины: {e}",
                    name="Ошибка аренды")

    @allure.title("Проверка функциональности МЗП за февраль")
    @allure.description("Проверка что страница минимальной зарплаты работает корректно")
    def test_minimum_wage_february_functionality(self):
        """
        Тест проверяет функциональность минимальной зарплаты за февраль
        """
        with allure.step("Проверяем доступность МЗП за февраль"):
            try:
                # Кликаем на "МЗП за февраль"
                ...
                assert success, "Не удалось перейти на страницу минимальной зарплаты"

                # Проверяем наличие характерных элементов
                has_correct_url = "minimalnoj-zarabotnoj-platy" in current_url

                allure.attach(
                    f"URL МЗП корректен: {has_correct_url}",
                    name="URL проверка")

                if has_correct_url:
                    # Проверяем наличие контента
                    try:
                        # Ищем признаки страницы МЗП
                        has_content = (
                            self.page.locator("h1, h2").count() > 0 or
                            self.page.locator(".content, .mzp, .minimum").count() > 0
                        )

                        allure.attach(
                            f"Контент МЗП загружен: {has_content}",
                            name="Контент МЗП")
                    except Exception as e:
                        allure.attach(
                            f"Ошибка при проверке контента: {e}",
                ...
                allure.attach(
                    f"Ошибка при проверке МЗП: {e}",
                    name="Ошибка МЗП")

    @allure.title("Проверка функциональности БПМ")
    @allure.description("Проверка что страница бюджета прожиточного минимума работает корректно")
    def test_bpm_functionality(self):
        """
        Тест проверяет функциональность бюджета прожиточного минимума
        """
        with allure.step("Проверяем доступность БПМ"):
            try:
                # Кликаем на "БПМ"
                ...
                # Проверяем наличие характерных элементов
                current_url = self.page.url
                has_correct_url = "46296" in current_url

                allure.attach(
                    f"URL БПМ корректен: {has_correct_url}",
                    name="URL проверка")

                if has_correct_url:
                    # Проверяем наличие контента
                    try:
                        # Ищем признаки страницы БПМ
                        has_content = (
                            self.page.locator("h1, h2").count() > 0 or
                            self.page.locator(".content, .bpm, .minimum").count() > 0
                        )

                        allure.attach(
                            f"Контент БПМ загружен: {has_content}",
                            name="Контент БПМ")
                    except Exception as e:
                        allure.attach(
                            f"Ошибка при проверке контента: {e}",
