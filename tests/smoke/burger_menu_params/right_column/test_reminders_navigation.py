"""
Burger Menu Right Column - Reminders Navigation - Multi-Domain Parameterized Tests.
...
class TestRemindersNavigationParams:
    ...
    def test_reminders_access(self, multi_domain_context, domain_aware_authenticated_context):
        ...
        Проверяет возможность открытия раздела напоминаний на всех доменах.
        Некоторые домены могут иметь ограниченный функционал напоминаний.
        """
