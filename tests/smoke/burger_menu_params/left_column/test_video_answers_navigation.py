...
class TestVideoAnswersNavigationParams:
    ...
    def test_video_answers_navigation(self, multi_domain_context, browser, fx_auth_manager):
        ...
        try:
            ...
            assert re.search(r'videootvety-490299', current_url), \
                f"URL не содержит паттерн видеоответов videootvety-490299: {current_url}"
        finally:
            page.close()
            context.close()
