...
class TestTestsNavigationParams:
    ...
    def test_tests_navigation(self, multi_domain_context, domain_aware_authenticated_context):
        ...
        try:
            ...
            assert "testy-dlya-proverki-znanij-212555" in current_url.lower(), \
                f"URL не содержит testy-dlya-proverki-znanij-212555: {current_url}"
        finally:
            page.close()
