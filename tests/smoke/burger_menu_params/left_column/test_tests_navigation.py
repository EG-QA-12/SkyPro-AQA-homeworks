"""
Burger Menu Left Column - Tests Navigation - Multi-Domain Parameterized Tests.
...
class TestTestsNavigationParams:
    ...
    def test_tests_navigation(self, multi_domain_context, browser):
        ...
        try:
            ...
            # URL contains knowledge test ID for all domains
            ...
            assert re.search(r'test-znanij-212555', current_url), \
                f"URL не содержит паттерн тестов test-znanij-212555: {current_url}"
        finally:
            page.close()
            context.close()
