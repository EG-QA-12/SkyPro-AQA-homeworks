...
class TestNavigatorsNavigationParams:
    ...
    def test_navigators_navigation(self, multi_domain_context, browser):
        ...
        try:
            ...
            # URL contains navigator reference ID for all domains
            ...
            assert re.search(r'navigatory-140000', current_url), \
                f"URL не содержит паттерн навигаторов navigatory-140000: {current_url}"
        finally:
            page.close()
            context.close()
