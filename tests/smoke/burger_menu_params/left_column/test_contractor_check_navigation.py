"""
Burger Menu Cross-Domain Navigation - Contractor Check - CP Domain.
...
class TestContractorCheckNavigationParams:
    ...
    def test_contractor_check_navigation(self, multi_domain_context, browser):
        ...
        try:
            ...
            # Cross-domain navigation to contractor platform
            ...
            assert re.search(r'cp\.bll\.by', current_url), \
                f"URL не содержит паттерн домена cp.bll.by: {current_url}"
        finally:
            page.close()
            context.close()
