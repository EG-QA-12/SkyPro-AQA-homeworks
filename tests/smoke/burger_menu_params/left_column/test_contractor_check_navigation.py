...
class TestContractorCheckNavigationParams:
    ...
    def test_contractor_check_navigation(self, multi_domain_context, domain_aware_authenticated_context):
        ...
        try:
            ...
            assert re.search(r'cp\.bll\.by', current_url), \
                f"URL не содержит паттерн домена cp.bll.by: {current_url}"        finally:
            page.close()
