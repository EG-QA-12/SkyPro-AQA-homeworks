"""
Burger Menu Cross-Domain Navigation - Community Search - Expert Domain.
...
class TestCommunitySearchNavigationParams:
    @pytest.mark.parametrize('multi_domain_context',['bll', 'expert', 'bonus', 'ca', 'cp'], indirect=True, ids=['Main(bll.by)', 'Expert', 'Bonus', 'CA', 'CP'])
    def test_community_search_navigation(self, multi_domain_context, domain_aware_authenticated_context):
