"""
Burger Menu Left Column - Directories Navigation - Multi-Domain Parameterized Tests.
"""
import pytest
...
class TestDirectoriesNavigationParams:
    ...
    def test_directories_navigation(self, multi_domain_context, browser):
        ...
        try:
            ...
            # URL contains directory reference ID for all domains
            current_url = page.url
            assert burger_menu.compare_docs_url_with_id(current_url, "220099"), \
                f"URL не содержит ожидаемый ID справочников 220099: {current_url}"
        finally:
            page.close()
            context.close()
