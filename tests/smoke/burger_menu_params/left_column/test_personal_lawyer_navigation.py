...
class TestPersonalLawyerNavigationParams:
    ...
    def test_personal_lawyer_navigation(self, multi_domain_context, browser):
        ...
        try:
            ...
            # URL contains personal lawyer ID for all domains
            ...
            assert re.search(r'lichnyj-yurist-206044', current_url), \
                f"URL не содержит паттерн личного юриста lichnyj-yurist-206044: {current_url}"
        finally:
            page.close()
            context.close()
