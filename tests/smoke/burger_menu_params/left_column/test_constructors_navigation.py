...
class TestConstructorsNavigationParams:
    ...
    def test_constructors_navigation(self, multi_domain_context, browser, fx_auth_manager):
        ...
        try:
            ...
            assert re.search(r'konstruktory-200077', current_url), \
                f"URL не содержит паттерн конструкторов konstruktory-200077: {current_url}"
        finally:
            page.close()
            context.close()
