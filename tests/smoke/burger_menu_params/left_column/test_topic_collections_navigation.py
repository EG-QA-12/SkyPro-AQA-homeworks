...
class TestTopicCollectionsNavigationParams:
    ...
    def test_topic_collections_navigation(self, multi_domain_context, domain_aware_authenticated_context):
        ...
        try:
            ...
            assert "podborki-vsyo-po-odnoj-teme-200084" in current_url.lower(), \
                f"URL не содержит podborki-vsyo-po-odnoj-teme-200084: {current_url}"
        finally:
            page.close()
