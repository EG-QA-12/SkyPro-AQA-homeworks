"""
Burger Menu Left Column - News Navigation - Multi-Domain Parameterized Tests.
...
class TestNewsNavigationParams:
    ...
    def test_news_navigation(self, multi_domain_context, domain_aware_authenticated_context):
        ...
        try:
            ...
            assert re.search(r'news|novosti', current_url), \
                f"URL не содержит паттерн новостей news или novosti: {current_url}"        finally:
            page.close()
