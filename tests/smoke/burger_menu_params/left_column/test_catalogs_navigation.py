...
class TestCatalogsNavigationParams:
    ...
    def test_catalogs_navigation(self, multi_domain_context, domain_aware_authenticated_context):
        ...
        try:
            ...
            assert re.search(r'katalogi-form-22555', current_url), \
                f"URL не содержит паттерн каталогов katalogi-form-22555: {current_url}"        finally:
            page.close()
