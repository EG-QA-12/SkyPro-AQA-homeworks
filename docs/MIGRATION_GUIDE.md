# Руководство по миграции на новый фреймворк

## Введение

Это руководство поможет вам мигрировать существующие тесты с старого фреймворка 
на новый, более современный и удобный фреймворк для автоматизации тестирования.
