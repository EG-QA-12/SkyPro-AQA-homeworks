...
> **Это основной архитектурный документ проекта.**
> Для практических инструкций и гайдов по запуску тестов используйте [README.md](./README.md) и [TESTING_GUIDE.md](./TESTING_GUIDE.md).
...
## Вспомогательные скрипты и интеграции

- Все вспомогательные скрипты для CI/CD, диагностики, генерации данных и интеграций находятся в папке scripts/ и её подпапках.
- Интеграционные и bulk-скрипты для управления пользователями, массовой авторизации и работы с БД находятся в projects/auth_management/scripts/.
- Все скрипты снабжены docstrings, поддерживают --help и описаны в соответствующих README.md.
- Устаревшие и дублирующие скрипты регулярно удаляются для поддержания чистоты структуры.
